...
public class AddNewAccount extends BaseIndigo{
	...
	public static void main(String[] args) throws MalformedURLException {
		...
		*/
		...
		driver.findElementByAndroidUIAutomator("text(\"Add account\")").click();
		
		
		driver.findElementById("com.shireburn.indigo:id/etUsername").sendKeys("Johnny_D@indigomobileapp");
		driver.findElementById("com.shireburn.indigo:id/btnLogin").click();
		
		driver.findElementById("com.shireburn.indigo:id/etPassword").sendKeys("Johnny*12345");
		driver.findElementById("com.shireburn.indigo:id/btnLogin").click();
